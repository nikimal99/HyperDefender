...
# ############### GNNGuard utils from modified deeprobust ####################################
...
def drop_dissimilar_edges(features, adj, metric='similarity', binary_feature= True, threshold=0.01):
...
def dropedge_jaccard(A, iA, jA, features, threshold):
    print("here threshold", threshold, type(threshold))
    removed_cnt = 0
